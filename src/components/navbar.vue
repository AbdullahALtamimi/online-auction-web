    ...
    <nav class="sidebar nav close">
      <header>
        <div class="image-text">
          <span class="image">
            <span class="name text-4xl">OAS</span>
          </span>

          <div class="text logo-text">
            <span class="name text-4xl">OAS</span>
            <span class="profession">project</span>
          </div>
        </div>
      ...
      <div class="menu-bar">
            ...
            <router-link to="/MyItem">
              <li v-if="user" class="nav-link">
                <a href="#">
                  ...
                  <span class="text nav-text">My Items</span>
                </a>
              </li></router-link
            >
          </ul>
        ...
        <li v-if="user" class="">
            <a href="#">
              ...
              <button class="text nav-text">{{user.userName}}</button>
            </a>
          </li>
          <li v-if="user" @click="handleclick()" class="">
            <a href="#">
          ...
          <router-link to="/login">
            <li v-if="!user" class="">
              <a href="#">
                ...
                <button class="text nav-text">login</button>
              </a>
            </li></router-link
          >
